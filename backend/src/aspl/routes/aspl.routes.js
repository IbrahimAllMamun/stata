...
const { register, checkRegistration, getRegistrations, approveRegistration, rejectRegistration, deleteRegistration } = require('../controllers/registration.controller');
